...
if __name__ == '__main__':
    ...
    parser.add_argument("--source_root_train", default="dataset/Cytopathology/train/trainB", type=str,
                        help="path to source images for training")
    parser.add_argument("--gt_root_train", default="dataset/Cytopathology/train/trainA", type=str,
